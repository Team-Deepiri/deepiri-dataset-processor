...
class DataLeakageDetector:
    ...
    def detect_train_eval_contamination(
        ...
        contamination_rate = (
            contamination_count / len(eval_texts) if eval_texts else 0.0
        )
        ...
        report = {
            ...
            "contaminated_texts": contaminated_texts[:10],
        }
    ...
    def detect_near_duplicates(
        ...
        report = {
            ...
            "near_duplicate_rate": (
                len(near_duplicates) / (len(texts) * (len(texts) - 1) / 2)
                if len(texts) > 1
                else 0.0
            ),
        }
